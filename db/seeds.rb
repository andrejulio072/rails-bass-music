...
#   Characater.create(name: "Luke", movie: movies.first)
# This file should contain all the record creation needed to seed the database with its default values.
...
a1 =
  Album.create(
    cover:
      "http://content.codecademy.com/projects/3/bass-music/my-beautiful-dark-twisted-fantasy.jpg",
...
a2 =
  Album.create(
    cover: "http://content.codecademy.com/projects/3/bass-music/beyonce.png",
    title: "Beyonce",
    artist: "Beyonce"
  )
...
a3 =
  Album.create(
    cover: "http://content.codecademy.com/projects/3/bass-music/21.png",
    title: "21",
    artist: "Adele"
  )
...
a4 =
  Album.create(
    cover:
      "http://content.codecademy.com/projects/3/bass-music/channel-orange.jpg",
...
a5 =
  Album.create(
    cover:
      "http://content.codecademy.com/projects/3/bass-music/good-kid-maad-city.jpg",
    title: "Good Kid, M.A.A.D City",
    artist: "Kendrick Lamar"
  )
Track.create(
  name: "Sherane a.k.a. Master Splinterâ€™s Daughter",
  minutes: 5,
  album_id: a5.id
)
...
Track.create(
  name: "Sing About Me, Iâ€™m Dying of Thirst",
  minutes: 13,
  album_id: a5.id
)
...
a6 =
  Album.create(
    cover: "http://content.codecademy.com/projects/3/bass-music/ram.jpg",
...
a7 =
  Album.create(
    cover:
      "http://content.codecademy.com/projects/3/bass-music/the-2020-experience.png",
